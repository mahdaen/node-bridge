...
class Bridge {
    ...
    /**
     * Get package information from scoped registry.
     *
     * @param name (string) Package name
     * @param version (string) Package version pattern.
     * @param scope (object) Registry scope object.
     * @returns {*}
     */
    static getpkg ( name, version, scope ) {
        if ( 'string' === typeof name && 'string' === typeof version && 'object' === typeof scope ) {
            ...
            let insver = self.matchvr(name, version, scope);
